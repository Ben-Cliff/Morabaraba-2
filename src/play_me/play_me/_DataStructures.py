...
# We are leacing this in case we way to use it again in a future version
#   simply left here in case we want it in future
# (some consoles dont allow coulour from these string additions)
